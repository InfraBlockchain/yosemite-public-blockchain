...
#$YOSEMITE_CLI_TESTNET push action allcamper reviewrental '{"rent_id":7002,"renter":"camperaaa111","score":8.5,"review_data_multihash":"QmfM2r8seH2GiRaC4esTjeraXEachRt8ZsSeGaWTPLyMoG"}' -p camperaaa111@active --txfee-payer allcampersvc -v producer.a
